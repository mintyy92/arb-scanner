...
<body>
    ...
    {% if events %}
        {% for event in events %}
            <div class="card">
                <div class="line"><strong>{{ event.match }}</strong></div>
                <div class="line">Bookmakers with props: {{ event.bookmaker_count }}</div>

                {% if event.offers %}
                    {% for offer in event.offers %}
                        <div class="offer">
                            <div class="line">{{ offer.player }}</div>
                    ...
                    {% endfor %}
                {% else %}
                    <div class="line">No raw offers found for this event.</div>
                {% endif %}
            </div>
        {% endfor %}
    {% else %}
